          ...
          {categories.map((category) => {
            ...
            return (
              <motion.div key={category.id} variants={itemVariants}>
                ...
                >
                  <div className="h-full p-8 rounded-3xl bg-card border border-border/50 shadow-md hover:shadow-xl transition-all duration-300 group-hover:-translate-y-1">
                    <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 ${category.bg} transition-transform group-hover:scale-110 duration-300 shadow-sm`}>
